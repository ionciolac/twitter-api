...
class CustomBasicAuthenticationFilter extends OncePerRequestFilter {
    ...
    SecurityInPort securityInPort

    CustomBasicAuthenticationFilter(SecurityInPort securityInPort) {
        this.securityInPort = securityInPort
    }
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (isBasicAuthentication(request)) {
            ...
            User user = securityInPort.getUserByUsername(username)
